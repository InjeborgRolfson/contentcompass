...
const translations: Translations = {
  ...
  tagline: {
    EN: "The things you love, all in one place.",
    TR: "Sevdileriniz, tek bir yerde.",
  },
  ...
  authorCreator: { EN: "Author/Creator", TR: "Yazar/Yapımcı" },
  year: { EN: "Year", TR: "Yıl" },
  note: { EN: "Personal Note", TR: "Kişisel Not" },
  contentType: { EN: "Content Type", TR: "İçerik Türü" },
  allFavorites: {
    EN: "★ All my favorites (Best results)",
    TR: "★ Tüm favorilerim (En iyi sonuçlar)",
  },
  ...
  selectHint: {
    EN: "Please select at least one favorite to find matches.",
    TR: "Eşleşmeleri bulmak için lütfen en az bir favori seçin.",
  },
  delete: { EN: "Delete", TR: "Sil" },
  undo: { EN: "Undo", TR: "Geri Al" },
  removedFromSaved: {
    EN: "Removed from saved items",
    TR: "Kaydedilenlerden kaldırıldı",
  },
  ...
  welcomeTitle: {
    EN: "Welcome to ContentCompass",
    TR: "ContentCompass'a Hoş Geldiniz",
  },
  welcomeStep1Title: { EN: "Add your favorites", TR: "Favorilerini Ekle" },
  welcomeStep1Desc: {
    EN: "Add the books, films, series, podcasts and anything you love.",
    TR: "sevdiğin kitapları, filmleri, dizileri, podcastleri ve daha fazlasını ekle",
  },
  welcomeStep2Title: { EN: "Discover", TR: "Keşfet" },
  welcomeStep2Desc: {
    EN: "Select your favorites and let the compass find content that matches your taste.",
    TR: "favorilerini seç ve pusula sana zevkine uygun içerikler bulsun",
  },
  welcomeStep3Title: {
    EN: "Save & Explore",
    TR: "Kaydet ve Keşfetmeye Devam Et",
  },
  welcomeStep3Desc: {
    EN: "Save recommendations you like and keep exploring.",
    TR: "beğendiğin önerileri kaydet ve keşfetmeye devam et",
  },
  ...
  emptyFavoritesSubtitle: {
    EN: "Start by adding the content you love — books, films, podcasts, anything.",
    TR: "Sevdiğin içerikleri eklemeye başla — kitaplar, filmler, podcastler ve daha fazlası.",
  },
  ...
  turkishContentDesc: {
    ...
    TR: "Yalnızca Türk yapımcılardan Türkçe içerik öner",
  },
  lengthFilter: { EN: "Length (Optional)", TR: "Uzunluk (İsteğe Bağlı)" },
  yearFilter: { EN: "Era (Optional)", TR: "Dönem (İsteğe Bağlı)" },
  short: { EN: "Short", TR: "Kısa" },
  medium: { EN: "Medium", TR: "Orta" },
  long: { EN: "Long", TR: "Uzun" },
  classic: { EN: "Classic", TR: "Klasik" },
  retro: { EN: "Retro", TR: "Retro" },
  modern: { EN: "Modern", TR: "Modern" },
  recent: { EN: "Recent", TR: "Güncel" },
  noteHelper: {
    EN: "Adding a note helps us give you more specific recommendations.",
    TR: "Not eklerseniz size daha kişiselleştirilmiş öneriler sunabiliriz.",
  },
  addCreatorInstead: {
    EN: "Add a Creator instead",
    TR: "Bunun yerine bir yaratıcı ekle",
  },
  addTitleInstead: {
    EN: "Add a specific title instead",
    TR: "Bunun yerine belirli bir içerik ekle",
  },
  creatorName: { EN: "Creator Name", TR: "Yaratıcının Adı" },
  creatorPlaceholder: {
    EN: "e.g., Stephen King, Jane Austen...",
    TR: "örn: Stephen King, Jane Austen...",
  },
  ...
  whyDoYouFollowThis: {
    EN: "Why do you follow this creator?",
    TR: "Bu sanatçıyı neden takip ediyorsun?",
  },
  ...
  noSeenContent: {
    EN: "You haven't marked any content as seen yet.",
    TR: "Henüz görülmüş olarak işaretlediğin içerik yok.",
  },
...
export const LanguageProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  return (
    <LanguageContext.Provider
      value={{ language, toggleLanguage, changeLanguage, t, formatText }}
    >
      {children}
    </LanguageContext.Provider>
  );
