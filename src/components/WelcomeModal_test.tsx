    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-indigo-950/40 backdrop-blur-md animate-in fade-in duration-300">
      <div className="bg-white w-full max-w-2xl max-h-[85vh] md:max-h-[90vh] rounded-[32px] shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 slide-in-from-bottom-8 duration-500">
        ...
        <div className="relative z-20 flex justify-end items-center px-6 pt-6 md:px-12 md:pt-8 bg-white/80 backdrop-blur-sm">
          ...
          <button 
            onClick={handleClose}
            className="p-2 h-10 w-10 flex items-center justify-center bg-indigo-50 hover:bg-indigo-100 rounded-full transition-colors text-indigo-600 shadow-sm"
            aria-label="Close"
          >
            <X className="w-5 h-5" />
          </button>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-8 pt-2 md:p-12 md:pt-4">
          <div className="text-center mb-12">
            ...
            <p className="text-indigo-900/60 max-w-md mx-auto text-sm md:text-base">
              {t('tagline')}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative pb-4">
            ...
            <div className="relative z-10 flex flex-col items-center text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-indigo-900/50 leading-relaxed max-w-[200px] md:max-w-none">
                  {t('welcomeStep1Desc')}
                </p>
              </div>
            </div>
        ...
        {/* Footer - Fixed */}
        <div className="p-6 md:p-8 pt-2 md:pt-4 bg-white/80 backdrop-blur-sm border-t border-indigo-50 flex justify-center pb-8 md:pb-12 safe-bottom-padding">
          <button
            onClick={handleClose}
            className="group flex items-center gap-3 px-10 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-bold shadow-xl shadow-indigo-100 transition-all hover:-translate-y-1 active:scale-95 w-full md:w-auto justify-center"
          >
            {t('getStarted')}
